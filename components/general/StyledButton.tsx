...
function StyledButton({ text, onClick, color } : StyledButtonProps) {
    ...
    return (
        <button onClick={() => onClick && onClick()} type="submit" className="w-full relative z-0 flex justify-between items-center px-4 py-2 hover:pr-2 transition-all group text-neutral-700">
